...
public class JavascripticLexer extends Lexer {
	...
	public static final String[] ruleNames = { "T__15", "T__14", "T__13",
			"T__12", "T__11", "T__10", "T__9", "T__8", "T__7", "T__6", "T__5",
			"T__4", "T__3", "T__2", "T__1", "T__0", "NOT", "MINUS", "MUL",
			"DIV", "MOD", "ADD", "LT", "LQ", "GT", "GE", "EQ", "NE", "NUM",
			"STR", "BOOL", "UNDEF", "ID", "COMMENT", "LINE_COMMENT", "WS",
			"DIGIT", "ID_LETTER", "ESC" };
	...
	public static final String _serializedATN = "\3\uacf5\uee8c\u4f5d\u8b0d\u4a45\u78bd\u1b2f\u3378\2&\u00fb\b\1\4\2\t"
